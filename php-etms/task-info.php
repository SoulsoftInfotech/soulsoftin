                  ...
                  <div class="">
                    ...
                    <select class="form-control rounded-0" name="assign_to" id="aassign_to" required>
                      ...
                      <?php while ($row1 = $info1->fetch(PDO::FETCH_ASSOC)) { ?>
                        <option><?php echo $row1['products']; ?></option>
                      <?php } ?>

                      <!-- <option value="">SKS</option>
                      <option value="">Shopcare</option>
                      <option value="">Grocary</option>
                      <option value="">SSI_website</option>
                      <option value="">Photography_website</option>
                      <option value="">Ecom_website</option> -->
...
<div class="row">
  <div class="col-md-12">
    <div class="well well-custom rounded-0">
      ...
      <center>
        <h3>Ticket Management Section</h3>
      </center>
      <div class="gap"></div>
        ...
        <table class="table table-codensed table-custom">
          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                <?php
                $q1 = "SELECT `products`, `year` FROM `products` WHERE `products` = `products`;";
                $info2 = $obj_admin->manage_all_info($q1);
                ?>
                <?php while ($row2 = $info2->fetch(PDO::FETCH_ASSOC)) ?>
                <td>SSI/<?php echo $row2['products']; ?>/2023/<?php echo $serial;
                                                              $serial++; ?></td>
