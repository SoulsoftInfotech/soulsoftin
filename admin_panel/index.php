...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php">Soulsoft Admin Panel</a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="./changeP.php">Change Passowrd</a></li>
                    <li>
                                                ...
                                                <th>
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="./decline.php?userid=<?php echo $row['id']; ?>">
                                                            ...
                                                            <button class="btn btn-danger btn-sm ml-2" name="delete">X</button>
                                                        </a>
                                                    </div>
